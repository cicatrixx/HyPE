...
% Get the relevant 3s bilcon dem tiles for lat lon center and winsize provided. 
% multiple tiles merged if needed
% Workflow:
    % load first tile corresponding to lat long
    % get focal point as center of first tile
    % 
% clear all
...
if isfile==0
    disp('Missing following 3s file:')
    bilname
    return;
end
